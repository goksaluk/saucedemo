...
Feature: Shopping succesfully
  ...
  Scenario Outline: Shopping with valid credentials
    ...
    And the user clicks the checkout button and see 3 products on the page and click the checkout button
    ...
    And complete page is visible to the user
    When the user clicks the backhome button
    Then the user is on the product page
